...
namespace Atealag {
    ...
    public partial class RaceDataDataSet : global::System.Data.DataSet {
        ...
        public partial class RaceTableDataTable : global::System.Data.TypedTableBase<RaceTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public RaceTableRow AddRaceTableRow(string Race, string Subrace) {
...
namespace Atealag.RaceDataDataSetTableAdapters {
    ...
    public partial class RaceTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `RaceTable` WHERE ((`ID` = ?) AND ((? = 1 AND `Race` IS NULL) OR (`Ra" +
                "ce` = ?)) AND ((? = 1 AND `Subrace` IS NULL) OR (`Subrace` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `RaceTable` (`Race`, `Subrace`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `RaceTable` SET `Race` = ?, `Subrace` = ? WHERE ((`ID` = ?) AND ((? = 1 AN" +
                "D `Race` IS NULL) OR (`Race` = ?)) AND ((? = 1 AND `Subrace` IS NULL) OR (`Subra" +
                "ce` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Race, Subrace FROM RaceTable";
        ...
        public virtual int Delete(int Original_ID, string Original_Race, string Original_Subrace) {
        ...
        public virtual int Insert(string Race, string Subrace) {
            if ((Race == null)) {
        ...
        public virtual int Update(string Race, string Subrace, int Original_ID, string Original_Race, string Original_Subrace) {
            if ((Race == null)) {
            ...
            if ((Original_Race == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Original_Race));
            }
            if ((Original_Subrace == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_Subrace));
            }
